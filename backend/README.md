...
## Project Structure
    ...
    ├── tst_daniel_screens__24236  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_screens__24236`
...
2. Clone this repo and `cd tst_daniel_screens__24236`
